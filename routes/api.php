...
Route::group(['middleware' => ['auth:api']], function () {
    Route::group(['middleware' => ['role:Admin']], function () {
        ...
        Route::post('admin/profile/edit', [AdminprofileController::class, 'update']);
...
Route::group(['middleware' => ['auth:api']], function () {
    Route::group(['middleware' => ['role:User']], function () {
        ...
        Route::post('user/profile/edit', [userprofileController::class, 'update']);
        Route::post('user/profile/change_password', [userprofileController::class, 'changePasswordSave']);

        //dashboard
        Route::get('user/properties/list', [UserDashboardController::class, 'userPropList']);
    });
});
